...
/**
 * Projects listing page — all active charity projects on-chain
 */
    ...
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="flex items-center justify-between flex-wrap gap-4">
            ...
            <div className="flex items-center gap-4 flex-wrap">
              {isOwner && (
                <Link
                  href="/admin/ngos"
                  className="text-bitcoin-orange hover:text-white hover:underline text-sm font-bold"
                >
                  Admin Dashboard
                </Link>
              )}
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="mb-6 flex items-center justify-between flex-wrap gap-4">
          <div>
            <h2 className="text-3xl font-bold text-slate-grey mb-2">Active Projects</h2>
          ...
          <div className="flex gap-3">
            ...
            <Link href="/project/create">
              <Button variant="secondary">Create Project (Page)</Button>
            </Link>
          </div>
        </div>
      ...
      <footer className="bg-slate-grey text-white mt-12 py-6">
        <div className="container mx-auto px-4 text-center">
          <p className="text-sm opacity-80">
            Built on Base • Transparent • Trustless • Decentralized
          </p>
        </div>
      </footer>
    </div>
